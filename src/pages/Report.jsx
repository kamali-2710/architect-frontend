...
import { REQUIREMENTS_API, IMAGE_URL } from "../api/api";
...
const Report = () => {
  ...
  const handleDelete = (id) => {
    ...
    setProjects(
      projects.filter((item) => item._id !== id)
    );
  };
    ...
    <div className="report-page">
      ...
      <div className="report-header">
        ...
        <div>
          ...
          <p>
            Real-time architecture project monitoring dashboard
          </p>
        </div>
        ...
        <div className="modal">
          ...
          <div className="modal-box">
            ...
            <p>
              <b>Architect :</b>
              {" "}
              {viewData.architect || "Not Assigned"}
            </p>
